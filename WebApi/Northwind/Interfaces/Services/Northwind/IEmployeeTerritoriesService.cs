...
namespace ThatConference.Northwind.Interfaces.Services.Northwind
{
    ...
    /// </summary>
    public interface IEmployeeTerritoriesService :
        ISelectableService<EmployeeTerritoriesDto, EmployeeTerritoriesFilter>,
        ISaveableWithBulkInsertService<EmployeeTerritoriesFilter, EmployeeTerritoriesDto, EmployeeTerritoriesDto>
    {
