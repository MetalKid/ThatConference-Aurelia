...
namespace ThatConference.Northwind.Interfaces.Services.Northwind
{
    ...
    public interface ICustomerDemographicsService :
        ISelectableService<CustomerDemographicsDto, CustomerDemographicsFilter>,
        ISaveableWithBulkInsertService<CustomerDemographicsFilter, CustomerDemographicsDto, CustomerDemographicsDto>
    {
