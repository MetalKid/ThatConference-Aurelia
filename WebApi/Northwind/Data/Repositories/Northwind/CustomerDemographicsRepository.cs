...
{
    /// <summary>
    /// This repository is responsible for getting, validating, and saving data for the [dbo].[CustomerDemographics] table.
    /// </summary>
    internal class CustomerDemographicsRepository : 
        RepositoryBase<INorthwindContext, CustomerDemographics, CustomerDemographicsFilter, INorthwindScope>, 
        ICustomerDemographicsRepository
    {
        ...
        public CustomerDemographicsRepository(
        ...
        protected override IQueryable<CustomerDemographics> ApplyGetIncludes(
            INorthwindContext ctx,
            IQueryable<CustomerDemographics> query, 
            CustomerDemographicsFilter filter)
        {
            if (filter == null)
            {
                return query;
        ...
        /// <param name="filter">The data to filter the request on.</param>
        /// <returns>The query object.</returns>
        protected override IQueryable<CustomerDemographics> ApplyGetOrderBy(
            INorthwindContext ctx,
            IQueryable<CustomerDemographics> query, 
            CustomerDemographicsFilter filter)
        {
        ...
        {
            var pk = new Lazy<string>(() => entity.CustomerTypeID);
            ...
            brokenRules.MaxLength(1073741823, entity.CustomerDesc, "CustomerDesc", "CustomerDesc", pk);
        }
