...
{
    /// <summary>
    /// This service makes calls to the [dbo].[CustomerDemographics] table.
    /// </summary>
    public class CustomerDemographicsService : 
        NorthwindServiceBase<CustomerDemographicsDto, CustomerDemographics, CustomerDemographicsFilter>, 
        ICustomerDemographicsServiceInternal
    {
        ...
        /// </param>
        public CustomerDemographicsService(
        ...
        #region << CustomerDemographicsDto Save Methods >>
        ...
        public void AssignFilterDataForSave(CustomerDemographicsFilter filter, CustomerDemographicsDto dto)
        {
