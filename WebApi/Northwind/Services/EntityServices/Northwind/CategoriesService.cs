...
{
    /// <summary>
    /// This service makes calls to the [dbo].[Categories] table.
    /// </summary>
    public class CategoriesService : 
        NorthwindServiceBase<CategoriesDto, Categories, CategoriesFilter>, 
        ICategoriesServiceInternal
    {
        ...
        #region << CategoriesDto Save Methods >>
        ...
        public void AssignFilterDataForSave(CategoriesFilter filter, CategoriesDto dto)
        {
            filter.CategoryID.EqualTo(dto.CategoryID);
