...
{
    /// <summary>
    /// This service makes calls to the [dbo].[Territories] table.
    /// </summary>
    public class TerritoriesService : 
        NorthwindServiceBase<TerritoriesDto, Territories, TerritoriesFilter>, 
        ITerritoriesServiceInternal
    {
        ...
        #region << TerritoriesDto Save Methods >>
        ...
        public void AssignFilterDataForSave(TerritoriesFilter filter, TerritoriesDto dto)
        {
            filter.TerritoryID.EqualTo(dto.TerritoryID);

            filter.IncludeRegion = dto.Region != null;
