...
{
    /// <summary>
    /// This service makes calls to the [dbo].[Products] table.
    /// </summary>
    public class ProductsService : 
        NorthwindServiceBase<ProductsDto, Products, ProductsFilter>, 
        IProductsServiceInternal
    {
        ...
        #region << ProductsDto Save Methods >>
        ...
        public void AssignFilterDataForSave(ProductsFilter filter, ProductsDto dto)
        {
            filter.ProductID.EqualTo(dto.ProductID);

            filter.IncludeCategories = dto.Categories != null;
            filter.IncludeSuppliers = dto.Suppliers != null;
            filter.IncludeOrderDetailOrderDetailses = dto.OrderDetailOrderDetailses != null;
        }
