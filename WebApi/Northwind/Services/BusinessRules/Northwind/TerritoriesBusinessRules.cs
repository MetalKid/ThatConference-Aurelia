...
namespace ThatConference.Northwind.Services.BusinessRules.Northwind
{
    ...
    /// Territories entity is saved.
    /// </summary>
    public class TerritoriesBusinessRules : ITerritoriesBusinessRules
    {
        ...
        public void ApplyRules(IList<BrokenRule> brokenRules, INorthwindScope scope, Territories entity)
        {
