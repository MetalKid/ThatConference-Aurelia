...
namespace ThatConference.Northwind.Services.BusinessRules.Northwind
{
    ...
    /// Shippers entity is saved.
    /// </summary>
    public class ShippersBusinessRules : IShippersBusinessRules
    {
        ...
        public void ApplyRules(IList<BrokenRule> brokenRules, INorthwindScope scope, Shippers entity)
        {
