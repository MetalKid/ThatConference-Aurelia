...
namespace ThatConference.Northwind.Services.BusinessRules.Northwind
{
    ...
    /// Customers entity is saved.
    /// </summary>
    public class CustomersBusinessRules : ICustomersBusinessRules
    {
        ...
        public void ApplyRules(IList<BrokenRule> brokenRules, INorthwindScope scope, Customers entity)
        {
