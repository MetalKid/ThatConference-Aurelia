...
namespace ThatConference.Northwind.Services.BusinessRules.Northwind
{
    ...
    /// OrderDetails entity is saved.
    /// </summary>
    public class OrderDetailsBusinessRules : IOrderDetailsBusinessRules
    {
        ...
        public void ApplyRules(IList<BrokenRule> brokenRules, INorthwindScope scope, OrderDetails entity)
        {
