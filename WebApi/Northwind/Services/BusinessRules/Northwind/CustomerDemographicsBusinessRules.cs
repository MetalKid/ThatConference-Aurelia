...
namespace ThatConference.Northwind.Services.BusinessRules.Northwind
{
    ...
    /// CustomerDemographics entity is saved.
    /// </summary>
    public class CustomerDemographicsBusinessRules : ICustomerDemographicsBusinessRules
    {
        ...
        public void ApplyRules(IList<BrokenRule> brokenRules, INorthwindScope scope, CustomerDemographics entity)
        {
