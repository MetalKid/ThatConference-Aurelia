...
namespace ThatConference.Northwind.Services.BusinessRules.Northwind
{
    ...
    /// Region entity is saved.
    /// </summary>
    public class RegionBusinessRules : IRegionBusinessRules
    {
        ...
        public void ApplyRules(IList<BrokenRule> brokenRules, INorthwindScope scope, Region entity)
        {
