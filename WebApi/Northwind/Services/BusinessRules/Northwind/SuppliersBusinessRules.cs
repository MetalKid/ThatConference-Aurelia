...
namespace ThatConference.Northwind.Services.BusinessRules.Northwind
{
    ...
    /// Suppliers entity is saved.
    /// </summary>
    public class SuppliersBusinessRules : ISuppliersBusinessRules
    {
        ...
        public void ApplyRules(IList<BrokenRule> brokenRules, INorthwindScope scope, Suppliers entity)
        {
