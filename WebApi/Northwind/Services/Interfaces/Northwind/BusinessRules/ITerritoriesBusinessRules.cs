...
{
    /// <summary>
    /// This interface defines business rules to run when attempting to save Territories entities.
    /// </summary>
    public interface ITerritoriesBusinessRules : IBusinessRuleValidation<Territories, INorthwindScope>
    {
    }
}
