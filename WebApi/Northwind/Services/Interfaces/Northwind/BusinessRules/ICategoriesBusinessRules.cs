...
{
    /// <summary>
    /// This interface defines business rules to run when attempting to save Categories entities.
    /// </summary>
    public interface ICategoriesBusinessRules : IBusinessRuleValidation<Categories, INorthwindScope>
    {
    }
}
