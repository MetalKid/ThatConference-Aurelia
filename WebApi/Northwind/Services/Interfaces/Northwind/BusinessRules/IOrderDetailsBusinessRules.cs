...
{
    /// <summary>
    /// This interface defines business rules to run when attempting to save OrderDetails entities.
    /// </summary>
    public interface IOrderDetailsBusinessRules : IBusinessRuleValidation<OrderDetails, INorthwindScope>
    {
    }
}
